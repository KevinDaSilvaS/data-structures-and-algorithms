...
function addPos($pos,$elem)
{
    ...
    $GLOBALS['antecessor'] = $GLOBALS['sucessor'];
...
function excluir($pos)
{
    ...
    foreach ($GLOBALS['elems'] as $key => $value) {
       ...
       if ($value['antecessor'] == $pos && $value['valor'] != null) {
            $GLOBALS['elems'][$key]['antecessor'] = $elementoExclusao['antecessor'];
       }
...
function reiniciarLista()
{
    ...
    $GLOBALS['elems'][$GLOBALS['cabeca']] = array(
        "valor"  => 'Nó Cabeça',
        "sucessor"  => 0,
        "antecessor"  => -1,
    );
